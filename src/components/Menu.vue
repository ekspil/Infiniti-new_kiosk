<template>
  <v-card flat tile class="overflow-auto" max-height="calc(100vh - 330px)">
      ...
      <v-row>
        ...
        >
          <v-card flat class="" @click="productToCart(product)">
            <v-img :src="product.img ? 'https://api.rb24.ru/api/v1/files/download/1/' + product.img : '/burger.png'" aspect-ratio="1.3" > </v-img>
